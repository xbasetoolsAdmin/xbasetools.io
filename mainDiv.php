...
<a class="dropdown-item" href="premium_cPanel" style="color: var(--font-color);"><span class="px-2"><i class="fas fa-leaf fa-fw"></i> Premium cPanels <span class="badge badge-primary">5876</span></span></a>
...
<div class="dropdown-menu dropdown-menu-left" style="color: var(--font-color); background-color: var(--color-nav);" aria-labelledby="navbarDropdown">
<a class="dropdown-item" href="business-1" style="color: var(--font-color);"><span class="px-2"><i class="fas fa-business-time"></i> cPanel Webmail <span class="badge badge-primary">7159</span></span></a>
<a class="dropdown-item" href="business-2" style="color: var(--font-color);"><span class="px-2"><i class="fas fa-mail-bulk"></i> Godaddy Webmail <span class="badge badge-primary">2226</span></span></a>
<a class="dropdown-item" href="business-3" style="color: var(--font-color);"><span class="px-2"><i class="fas fa-globe"></i> Office365 Webmail <span class="badge badge-primary">9743</span></span></a>
...
<option value="https://my.bluehost.com/web-ho">https://my.bluehost.com/web-ho</option><option value="https://portal.azure.com">https://portal.azure.com</option><option value="https://signin.aws.amazon.com/">https://signin.aws.amazon.com/</option><option value="https://uk.hosting24.com/cpane">https://uk.hosting24.com/cpane</option> </select>
</div>
...
<option value="United Kingdom">United Kingdom</option><option value="United States">United States</option> </select>
</div>
...
<option value="">All</option>
<option value="Seller349">Seller349</option><option value="Seller327">Seller327</option><option value="Seller342">Seller342</option> </select>
</div>
</div>
