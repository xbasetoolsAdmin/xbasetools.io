...
<div class="containerfluid m-5 bseller">
<h3 class="text-center alert alert-success">Interested in becoming a seller at Odin Shop ?</h3>
Okay then let us explain your Features and tell you some rules .<br>
<h4 class="mt-2"><i class="fas fa-globe"></i></span> Your Features</h4>
<ul class="p-3">
<li>You get <b>50%</b> of your sales via bitcoin <span class="glyphicon glyphicon-bitcoin"></span> </li>
<li>You get paid any time you like when you have 50$+!</li>
...
<h4 class="mt-2"><i class="fas fa-exclamation-triangle"></i></span> Our Rules</h4>
<ul class="p-3">
...
<li>we do not accept the sale of fraudlent material ( no cc / banks etc ... )</li>
<li>you have to be an active seller and help customers in their reports</li>
<li>seller account will be deleted if you violate any of our rules</li>
</ul>
<h4 class="mt-2"><i class="fas fa-list"></i> How to Apply ?</h4><br>
<li>You can have a seller status by paying 20$ for only one time [no extra fees]</li>
<div id="showms"></div>
<br>
<a class="btn btn-primary btn-md" data-toggle="modal" data-target="#showmagseyesorno" style="font-size: 15px; cursor:pointer;font-weight: bold;"><i class="fas fa-shopping-cart mr-1"></i> Purchase Seller Account </a>
</div>
</div>
</div>
...
<p class="heading">Confirm Pay 20$ to open the Seller Panel.</p>
</div>
...
<a onclick="javascript:applyseller()" class="btn btn-outline-info waves-effect" data-dismiss="modal">Yes</a>
