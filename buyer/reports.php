...
#report_data_paginate .paginate_button {
color: var(--font-color);
...
<h3 class="text-center text-primary mb-7">How to report a bad item ? </h3>
<p class="text-center" style="color: var(--font-color); background-color: var(--color-card);"><b>Account</b> &gt; <b>My Orders or purchases in right sidebar</b>, then choose the item you want to report and click on <b>Report</b> button</p>
</br>
<table id="report_data" class="display responsive table-hover" style="width:100%;color: var(--font-color); background-color: var(--color-card);">
<thead>
<tr>
<th></th>
<th>ID</th>
...
<script>
        ...
        function load_data(seller) {
            $('#report_data').DataTable({
                ...
                "fnCreatedRow": function( nRow, aData, iDataIndex ) {
                    $(nRow).attr('data-report-id', aData[1]);
                },
    ...
    function showReport(id){
         window.location = 'showReport'+id + ".html" ;
        }
