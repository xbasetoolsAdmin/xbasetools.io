...
if (!isset($_SESSION['sname']) and !isset($_SESSION['spass'])) {
    header("location: ../"); exit(); } $usrid = mysqli_real_escape_string($dbcon $_SESSION['sname']); ?>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8" />
...
<a class="dropdown-item" href="rdpsl" style="color: var(--font-color);"><span class="px-2"><i class="fas fa-desktop fa-fw"></i> RDPs <span class="badge badge-primary">77</span></span></a>




<a class="dropdown-item" href="cPanel" style="color: var(--font-color);"><span class="px-2"><i class="fas fa-tools fa-fw"></i> cPanels <span class="badge badge-primary">8874</span></span></a>

<a class="dropdown-item" href="shell" style="color: var(--font-color);"><span class="px-2"><i class="fas fa-file-code fa-fw"></i> Shells <span class="badge badge-primary">1500</span></span></a>
</div>
</li>
...
<li>There is <b> 1 </b> Accounts Available.</li>
</ul>
</div>
