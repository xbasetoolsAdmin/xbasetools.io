...
.selected-rating .checked { color: #c59b08; }

.ratingmodal .well { margin-top: 20px; }
...
<div class="well mt-5">
<h2 style="color: var(--font-color);"><center><small><font color="var(--font-color)"><i class="fa fa-shopping-cart"></i></span></small></font> My Orders </h2>
<p align="center" style="color: var(--font-color);">You can only report a bad tool within <b>12 hours</b> by clicking on <a class="btn btn-primary btn-sm"><font color=white>Report #[Order Id]</a></font> , Otherwise we can't give you refund or replacement!</p>
</div>
...
$('#ratingModal'+ idorder).modal({ show: true });
}
