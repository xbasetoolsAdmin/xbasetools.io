...
<body class="them">
        ...
        <div class="collapse navbar-collapse order-1" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item dropdown mr-auto">
                    ...
                    <div class="dropdown-menu dropdown-menu-left" style="color: var(--font-color); background-color: var(--color-nav);" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="premium_shell" style="color: var(--font-color);"><span class="px-2"><i class="fas fa-leaf fa-fw"></i> Premium Shells <span class="badge badge-primary">1081</span></span></a>
                        <a class="dropdown-item" href="premium_cPanel" style="color: var(--font-color);"><span class="px-2"><i class="fas fa-leaf fa-fw"></i> Premium cPanels <span class="badge badge-primary">6038</span></span></a>
                ...
                <li class="nav-item dropdown mr-auto">
                    ...
                    <div class="dropdown-menu dropdown-menu-left" style="color: var(--font-color); background-color: var(--color-nav);" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="mailer" style="color: var(--font-color);"><span class="px-2"><i class="fas fa-leaf fa-fw"></i> Mailers <span class="badge badge-primary">403</span></span></a>
                        <a class="dropdown-item" href="smtp" style="color: var(--font-color);"><span class="px-2"><i class="fas fa-envelope fa-fw"></i> SMTPs <span class="badge badge-primary">2658</span></span></a>
                    </div>
                </li>
    ...
    <div class="well mt-5">
        <h2 style="color: var(--font-color);">
            <center><small>
                    <font color="var(--font-color)"><i class="fa fa-shopping-cart"></i></span>
                </small></font> My Orders
        </h2>
        <p align="center" style="color: var(--font-color);">You can only report a bad tool within <b>12 hours</b> by clicking on <a class="btn btn-primary btn-sm">
                <font color=white>Report #[Order Id]
            </a></font> , Otherwise we can't give you refund or replacement!</p>
    </div>
    <div class="row m-1 pt-3">
        <div class="col-sm-12 table-responsive">
            <table id="order_data" class="display responsive table-striped table-hover" style="max-width:100%; color: var(--font-color); background-color: var(--color-card);">
                <thead>
                    <tr>
                        <th></th>
                        <th class="all">ID</th>
    ...
    <script>
        function getTimeServer(x, countDownDate, id) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    document.getElementById(id).innerHTML = " report: " + hours + "h " +
                        minutes + "min ";
        ...
        function getTimeServerInit(countDownDate, id) {
        ...
        function openrating(idorder, idsller) {
            var openmodel = '<div class="modal fade ratingmodal" id="ratingModal' + idorder + '" ><div class="modal-dialog"><div class="modal-content"><div class="modal-header"><h4 class="modal-title">Give your Rating</h4></div><div class="modal-body"> <p id="error-' + idorder + '" style="display:none;"><span class="alert alert-danger"></span></p> <div class="well well-sm">  <h4><b>Rate to Seller - <a href="profile-Seller' + idsller + '" class="btn btn-primary btn-sm" style="font-size: 11px; cursor:pointer" target="_blank"><i class="fas fa-user mr-1"></i>Seller' + idsller + '</a></b></h4> </div> <div id="rating-' + idorder + '">  <div class="input-group"><div class="rate"> <input type="radio" id="star5-' + idorder + '" name="rate" value="5" /> <label for="star5-' + idorder + '" title="star5">5 stars</label> <input type="radio" id="star4-' + idorder + '" name="rate" value="4" /> <label for="star4-' + idorder + '" title="star4">4 stars</label> <input type="radio" id="star3-' + idorder + '" name="rate" value="3" /> <label for="star3-' + idorder + '" title="star3">3 stars</label> <input type="radio" id="star2-' + idorder + '" name="rate" value="2" /> <label for="star2-' + idorder + '" title="star2">2 stars</label> <input type="radio" id="star1-' + idorder + '" name="rate" value="1" /> <label for="star1-' + idorder + '" title="star1">1 star</label></div><div class="review"> <textarea id="review-' + idorder + '"  class="form-control custom-control" rows="3" cols="40" name="review" style="resize:none" required="" placeholder="Write your review here..!"></textarea></div><div class="action"> <span class="input-group-addon btn btn-primary ml-2" onclick="this.disabled=true;javascript:sendReview(' + idorder + ');">Submit</span></div></div> </div></div><div class="modal-footer"> <button type="button" class="btn btn-primary" data-dismiss="modal">Close</button></div></div> </div></div>';
            $("div#ratingmodel").html(openmodel);
            $('#ratingModal' + idorder).modal({
                show: true
            });
        }
    </script>
